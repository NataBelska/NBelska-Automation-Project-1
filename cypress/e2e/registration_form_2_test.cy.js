...
describe('Section 1: Functional tests', () => {
    ...
    it('User can use only same both first and validation passwords', () => {
        ...
        cy.get('#email').type('Nata@gmail.com')
    ...
    it('User can submit form with all fields added', () => {
        ...
        cy.get('input[name="password"]').type('Natatest1')
        cy.get('[name="confirm"]').type('Natatest1{enter}')
    ...
    it.only('Submit button is not enabled when some mandatory field is not present', () => {

        MandatoryFields('Nata')
    ...
    */
    ...
    describe('Section 2: Visual tests', () => {
        it('Check that logo is correct and has correct size', () => {
            ...
            cy.get('img').invoke('height').should('be.lessThan', 178)
             ...
             //eto poslednee do konca IT testa Nata sama iz chatGPT napisala:
                cy.get('img').then(($img) => {
                    const width = $img[1].naturalWidth; // Retrieve the natural width of the image
                    const height = $img[1].naturalHeight; // Retrieve the natural height of the image
                  
                    // Log the width and height to the Cypress command log
                    cy.log(`Image width: ${width}, height: ${height}`);
                  });
                  cy.get('img').then(($img) => {
                    // Log the width and height to the Cypress command log
                    cy.log(`Image width: ${$img[0].naturalWidth}, height: ${$img[0].naturalHeight}`);
                    cy.log(`Image width: ${$img[1].naturalWidth}, height: ${$img[1].naturalHeight}`);
    ...
    function MandatoryFields(username) {
